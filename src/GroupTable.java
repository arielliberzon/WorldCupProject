 ...
 *   this class will create the tables for the GroupStage class,
 *   GroupStage is composed of this (I'm pretty sure)
 *      - Justin V
 */
...
public class GroupTable {
    ...
    public GroupTable(int a, int b, ArrayList<String> list, String color, String group) {
        this.colmnun = a;
        this.row = b;
        this.list = list;
        this.color = color;
    ...
    //second constructor
    public GroupTable(ArrayList<String> team1, ArrayList<Button> playButton, ArrayList<String> team2) {
        this.team1 = team1;
    ...
    public GridPane tablePainting() {
        ...
        for (int i = 0; i < row; i++) {
            for (int j = 0; j < colmnun; j++) {
                ...
                stack.setMaxSize(50, 27);
                stack.setMinSize(50, 27);
